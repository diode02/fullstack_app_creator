...
class formsCodeService {
  ...
  generateClassAndState(schemaTable, schemaRelations) {
    ...
    for (var column in tblColumns) {
      code = code.concat(" " + tblColumns[column].name + ': "",');
    }
    if (schemaRelations != null) {
      for (var index in schemaRelations) {
        firstTable = schemaRelations[index].firstTable; // get each realtions firstTable
    ...
    for (var column in tblColumns) {
      ...
      code = code.concat(
        "                onChange={this.handleChange}\n" +
          ...
          '"\n' +
          '                type="' +
          tblColumns[column].type +
          '"\n' +
          '                className="form-control"\n' +
          "              />\n" +
          '              {this.state.errors["' +
          tblColumns[column].name +
          '"] && <div className="alert alert-danger">{this.state.errors["' +
          tblColumns[column].name +
          '"]}</div>}\n' +
          "          </div>\n\n"
      );
          ...
          if (
            ...
            code = code.concat(
              '          <div className="form-group">\n' +
                ...
                '              {this.state.errors["' +
                secondTable +
                'Id"] && <div className="alert alert-danger">{this.state.errors["' +
                secondTable +
                'Id"]}</div>}\n' +
                "          </div>\n\n"
            );
            ...
            code = code.concat(
              '          <div className="form-group">\n' +
                ...
                "                  <div key={" +
                secondTable +
                '._id} className="custom-control custom-radio custom-control-inline">\n' +
                "                    <input \n" +
                '                      type="radio" value={' +
                secondTable +
                "._id} onChange={this.handleChange} \n" +
                '                      className="custom-control-input" id={' +
                secondTable +
                '._id} name="' +
                secondTable +
                'Id" \n' +
            ...
            code = code.concat(
              '          <div className="form-group">\n' +
                ...
                "                    <div key={" +
                secondTable +
                '._id} className="custom-control custom-checkbox custom-control-inline">\n' +
                "                        <input \n" +
                '                          type="checkbox" value={' +
                secondTable +
                "._id} onChange={this.handleCheckBoxChange}\n" +
                '                          className="custom-control-input" id={' +
                secondTable +
                '._id} name="' +
                secondTable +
